  ...
  private resolveCallWithInfo(
    ...
    if (reasoning === undefined) {
      if (requested !== undefined) {
        // Free/proxy routes may forward a shared effort to models that do not
        // advertise reasoning. Preserve the request and omit only this
        // unsupported field instead of rejecting an otherwise valid call.
