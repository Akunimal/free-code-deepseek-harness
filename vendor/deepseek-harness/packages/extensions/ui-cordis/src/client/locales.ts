...
export const es = {
  ...
  'panel.hint': 'Los controles de ejecución están en el panel Cordis, encima de Configuración',
  ...
  'render.failedAbdicated': 'Falló el renderizado de {slot}; se restauró la interfaz predeterminada:',
  'render.failedHeld': 'Falló el renderizado de {slot}:',
  'a11y.defining': 'Registrando el plugin',
  'a11y.failed': 'Falló el registro',
  'a11y.stopped': 'Registro interrumpido',
