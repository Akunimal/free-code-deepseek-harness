...
export const es: Record<AgentPresetSettingsKey, string> = {
  ...
  sectionIntro: 'Un preajuste es la composición de plugins con la que se ejecuta el agente de una sesión: sus herramientas, prompt y capacidades. Duplica uno existente y hazlo tuyo, o deja que el agente prepare uno en modo Creador.',
  builtIn: 'Integrado',
  setDefault: 'Establecer como predeterminado',
  view: 'Ver',
  presetStandardName: 'Modo estándar',
  presetStandardDescription: 'Agente de programación completo con edición de archivos, Shell, búsqueda de archivos y web, skills, planificación, objetivos, subagentes y flujos de trabajo.',
  ...
  presetCordisDescription: 'Diseñado para crear preajustes de agente personalizados, con todas las capacidades del modo estándar y además inspección del entorno, experimentos con plugins y guía para crear preajustes.',
  duplicate: 'Duplicar',
