...
describe('invariant companion', () => {
  ...
  it('client apply provides ctx.locale seeded with the zh/en/es common namespace', async () => {
    ...
    expect(() => (locale as LocaleRuntime).register(COMMON_NS, 'es', {})).toThrow('already has locale')
  })
})
