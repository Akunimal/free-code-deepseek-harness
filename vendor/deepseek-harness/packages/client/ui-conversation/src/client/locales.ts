...
export const es = {
  ...
  'placeholder.parentOffline': 'La sesión principal está desconectada; no se pueden enviar mensajes, pero puedes detener la ejecución',
  ...
  'image.dropBlocked': 'Ahora no se pueden añadir imágenes',
  ...
  'image.serviceUnavailable': 'El servicio de carga de imágenes no está disponible',
  ...
  'image.modelUnsupported': 'El modelo actual no admite imágenes; cambia a un modelo compatible',
  'image.subagentUnsupported': 'Las sesiones de subagentes todavía no admiten imágenes',
  'image.sendFailed': 'No se pudieron enviar las imágenes ({reason}); vuelve a añadirlas e inténtalo de nuevo',
  'context.aria': '{percent} del contexto utilizado',
  'context.used': 'del contexto utilizado',
  'context.system': 'Instrucciones del sistema',
  ...
  'stats.ttftAverage': 'TTFT promedio {duration}',
  'stats.tokensPerSecond': '{throughput} tokens/s',
  'stats.cacheHit': 'Acierto de caché {percent}%',
  'stats.tokens': 'Entrada {input} tokens · Salida {output} tokens',
  'settings.enter.title': 'Comportamiento de Enter mientras está ocupado',
  'settings.enter.description': 'Solo mientras está ocupado; Cmd/Ctrl+Enter usa el otro comportamiento',
  'settings.enter.queue': 'Poner en cola',
  'settings.enter.steer': 'Dirigir',
  'access.confirm.title': '¿Activar el acceso total?',
  'access.confirm.description': 'El acceso total reduce los pasos de confirmación y permite al agente realizar más acciones directamente, incluidas operaciones sensibles, cambios de archivos o comandos externos. Úsalo solo cuando confíes en la tarea actual.',
  ...
  'message.compaction.unavailable': 'El resumen de compactación no está disponible',
  ...
  'message.branch': 'Crear una rama en una conversación nueva',
  'message.branchUnavailable': 'Solo está disponible en el último mensaje de un turno completado',
  ...
  'message.retry.status': '{label} ({retry}/{maximum}) · {seconds}s',
  'message.retry.delay': 'Demora del reintento: ',
  'message.retry.failure': 'Motivo del fallo: ',
  'message.turnError': 'Falló este turno',
  'message.maxTokens': 'Se alcanzó el límite de tokens de salida',
  'message.maxTokens.hint': 'La respuesta se cortó; la salida anterior se conserva en la conversación. Envía «continuar» para que el modelo reanude.',
  'message.ranFor': 'Se ejecutó durante {duration}',
  'turn.deepDiving': 'Pensando a fondo…',
  'message.ttft': 'TTFT {seconds}s',
  'message.tokensPerSecond': '{tps} tokens/s',
  'duration.seconds': '{seconds}s',
  ...
  'command.imagesUnsupported': '/{command} no admite adjuntos de imagen; quítalos primero',
  'approval.waiting': 'Esperando aprobación',
  'approval.detail.aria': 'Detalles de aprobación',
  ...
  'queue.edit.unsupported': 'Contiene contenido no textual; todavía no se puede editar',
  ...
  'queue.editFailed': 'Falló la edición: puede que este mensaje ya haya comenzado a enviarse.',
  'queue.removeFailed': 'Falló la eliminación: puede que este mensaje ya haya comenzado a enviarse.',
  'queue.steerFailed': 'Falló la dirección. Inténtalo de nuevo.',
