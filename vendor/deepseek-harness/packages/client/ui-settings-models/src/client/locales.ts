...
export const es: { [Key in keyof typeof en]: string } = {
  ...
  deleteDescription: 'Eliminar {provider} quita su configuración. Cualquier credencial que use se administra en otro lugar y se conservará.',
  ...
  conflict: 'Alguien modificó esta configuración mientras la tarjeta estaba abierta. Ciérrala y vuelve a abrirla para editar los valores actuales.',
  retry: 'Reintentar',
  keyInput: 'Clave API',
  keyPlaceholder: 'Introduce tu clave API',
  keyPlaceholderNative: 'Introduce una clave API o déjalo vacío para usar la autenticación del entorno',
  ...
  modelsEmpty: 'No se mostrarán modelos en el selector. Los ID no listados aún se pueden enviar directamente.',
  keyBlank: 'Introduce la clave API o deja el campo vacío para conservar la almacenada.',
  keyBlankNew: 'Introduce la clave API o deja el campo vacío si este proveedor se autentica de otra manera.',
  ...
  modelContextInvalid: 'La ventana de contexto debe ser un valor positivo, como 131072, 256K o 1M.',
  modelMaxTokensInvalid: 'Los tokens máximos de salida deben ser un valor positivo, como 8192, 64K o 1M.',
  ...
  fetchEmpty: 'El proveedor no indicó modelos. Agrégalos manualmente.',
  fetchTitle: 'Elegir modelos para agregar',
  fetchDescription: 'Estos son los modelos disponibles de este proveedor. Elige cuáles agregar.',
  ...
  customRouteHint: 'Identificador en minúsculas, comenzando con una letra, que nombra de forma única al proveedor en las solicitudes y como nombre de credencial.',
  customRouteInvalid: 'Comienza con una letra minúscula; después usa letras minúsculas, dígitos y guiones.',
