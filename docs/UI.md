...
The implementation is intentionally separate from Hermes source code and copies the visual idea rather than its runtime. This keeps the effect light and avoids tying the harness to Hermes packages or binaries.
